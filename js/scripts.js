...
//funçao atualiza  tarefa no local storage
const updateTodoStatusLocalStorage = (todoText)=>{
   const todos = getTodoLocal()

   //percorre a tarefa e adiciona a classe done que deixa em azul caso muda o estato para feito
